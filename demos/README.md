...
- Each file is self-contained. Stylesheet path is `../tachyons.css`; demos for application tokens also load `../app.css`.
...
| [app.html](app.html)                 | App shell      | `app.css` semantic tokens, scoped `data-theme`, action/state utilities, focus helpers |
